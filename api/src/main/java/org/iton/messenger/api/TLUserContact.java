...
public class TLUserContact extends User {
    ...
    public TLUserContact(int id, String first_name, String last_name, String username, long access_hash, String phone, UserProfilePhoto photo, UserStatus status) {
        this.id          = id;
