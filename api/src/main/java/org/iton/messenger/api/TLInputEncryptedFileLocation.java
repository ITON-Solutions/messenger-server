...
public class TLInputEncryptedFileLocation extends InputFileLocation {
    public static final int CLASS_ID = 0xf5235d55;

    public TLInputEncryptedFileLocation() {
    }

    public TLInputEncryptedFileLocation(long id, long access_hash) {
        this.id          = id;
    ...
    public String toString() {
        return "input.encryptedFileLocation#f5235d55";
    }
}